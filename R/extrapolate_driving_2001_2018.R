...
dir.create("tmp")
unzip("D:/OneDrive - University of Leeds/Data/OA Bounadries/",
      exdir = "tmp")
...
cents <- cents[,c("code","PC_AREA")]

mot_2011 <- left_join(mot_2011, cents, by = c("LSOA11" = "code"))
summary(is.na(mot_2011$PC_AREA))

mot_postcode <- mot_postcode[,c("postcodearea","X2012","X2013","X2014","X2015","X2016","X2017","X2018")]
...
mot_2011$car_km_14 <- mot_2011$car_km_11 * mot_2011$X2014
mot_2011$car_km_15 <- mot_2011$car_km_11 * mot_2011$X2015
mot_2011$car_km_16 <- mot_2011$car_km_11 * mot_2011$X2016
mot_2011$car_km_17 <- mot_2011$car_km_11 * mot_2011$X2017
mot_2011$car_km_18 <- mot_2011$car_km_11 * mot_2011$X2018


mot_2011$van_km_12 <- mot_2011$van_km_11 * mot_2011$X2012
mot_2011$van_km_13 <- mot_2011$van_km_11 * mot_2011$X2013
mot_2011$van_km_14 <- mot_2011$van_km_11 * mot_2011$X2014
mot_2011$van_km_15 <- mot_2011$van_km_11 * mot_2011$X2015
mot_2011$van_km_16 <- mot_2011$van_km_11 * mot_2011$X2016
mot_2011$van_km_17 <- mot_2011$van_km_11 * mot_2011$X2017
mot_2011$van_km_18 <- mot_2011$van_km_11 * mot_2011$X2018

names(mot_2011)

mot_2011 <- mot_2011[,!grepl("X",names(mot_2011))]
mot_2011 <- mot_2011[,c("LSOA11","vans_total_09","vans_total_10","vans_total_11",
                        "van_km_09","van_km_10","van_km_12","van_km_13","van_km_14","van_km_15","van_km_16","van_km_17","van_km_18",
                        "car_km_09","car_km_10","car_km_12","car_km_13","car_km_14","car_km_15","car_km_16","car_km_17","car_km_18")]
