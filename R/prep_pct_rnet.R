...
rent <- rbind(net_comm, net_school)

rnet2 <- stplanr::overline2(rent, attrib = c("bicycle","govtarget_slc","dutch_slc"),
                           ncores = 30)
...
st_write(rnet2, "data/pct/rnet_high.geojson")
st_write(rnet_med, "data/pct/rnet_med.geojson")
st_write(rnet_low, "data/pct/rnet_low.geojson")
