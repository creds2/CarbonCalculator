...
all_la <- all %>%
  group_by(LAD17NM) %>% 
  summarise(gas_percap_2010 = signif(mean(gas_percap_2010, na.rm = TRUE), digits = 3),
            gas_percap_2011 = signif(mean(gas_percap_2011, na.rm = TRUE), digits = 3),
            gas_percap_2012 = signif(mean(gas_percap_2012, na.rm = TRUE), digits = 3),
            gas_percap_2013 = signif(mean(gas_percap_2013, na.rm = TRUE), digits = 3),
            gas_percap_2014 = signif(mean(gas_percap_2014, na.rm = TRUE), digits = 3),
            gas_percap_2015 = signif(mean(gas_percap_2015, na.rm = TRUE), digits = 3),
            gas_percap_2016 = signif(mean(gas_percap_2016, na.rm = TRUE), digits = 3),
            gas_percap_2017 = signif(mean(gas_percap_2017, na.rm = TRUE), digits = 3),
            gas_percap_2018 = signif(mean(gas_percap_2018, na.rm = TRUE), digits = 3),
            elec_percap_2010 = signif(mean(elec_percap_2010, na.rm = TRUE), digits = 3),
            elec_percap_2011 = signif(mean(elec_percap_2011, na.rm = TRUE), digits = 3),
            elec_percap_2012 = signif(mean(elec_percap_2012, na.rm = TRUE), digits = 3),
            elec_percap_2013 = signif(mean(elec_percap_2013, na.rm = TRUE), digits = 3),
            elec_percap_2014 = signif(mean(elec_percap_2014, na.rm = TRUE), digits = 3),
            elec_percap_2015 = signif(mean(elec_percap_2015, na.rm = TRUE), digits = 3),
            elec_percap_2016 = signif(mean(elec_percap_2016, na.rm = TRUE), digits = 3),
            elec_percap_2017 = signif(mean(elec_percap_2017, na.rm = TRUE), digits = 3),
            elec_percap_2018 = signif(mean(elec_percap_2018, na.rm = TRUE), digits = 3),
            other_heat_percap_2011 = signif(mean(other_heat_percap_2011, na.rm = TRUE), digits = 3),
            flights_percap_2018 = signif(mean(flights_percap_2018, na.rm = TRUE), digits = 3),
            nutrition_kgco2e_percap = signif(mean(nutrition_kgco2e_percap, na.rm = TRUE), digits = 3),
            other_shelter_kgco2e_percap = signif(mean(other_shelter_kgco2e_percap, na.rm = TRUE), digits = 3),
            consumables_kgco2e_percap = signif(mean(consumables_kgco2e_percap, na.rm = TRUE), digits = 3),
            recreation_kgco2e_percap = signif(mean(recreation_kgco2e_percap, na.rm = TRUE), digits = 3),
            services_kgco2e_percap = signif(mean(services_kgco2e_percap, na.rm = TRUE), digits = 3),
            commute_noncar_percap = signif(mean(commute_noncar_percap, na.rm = TRUE), digits = 3),
            car_percap_2010 = signif(mean(car_percap_2010, na.rm = TRUE), digits = 3),
            car_percap_2011 = signif(mean(car_percap_2011, na.rm = TRUE), digits = 3),
            car_percap_2012 = signif(mean(car_percap_2012, na.rm = TRUE), digits = 3),
            car_percap_2013 = signif(mean(car_percap_2013, na.rm = TRUE), digits = 3),
            car_percap_2014 = signif(mean(car_percap_2014, na.rm = TRUE), digits = 3),
            car_percap_2015 = signif(mean(car_percap_2015, na.rm = TRUE), digits = 3),
            car_percap_2016 = signif(mean(car_percap_2016, na.rm = TRUE), digits = 3),
            car_percap_2017 = signif(mean(car_percap_2017, na.rm = TRUE), digits = 3),
            car_percap_2018 = signif(mean(car_percap_2018, na.rm = TRUE), digits = 3),
            van_percap_2010 = signif(mean(van_percap_2010, na.rm = TRUE), digits = 3),
            van_percap_2011 = signif(mean(van_percap_2011, na.rm = TRUE), digits = 3),
            van_percap_2012 = signif(mean(van_percap_2012, na.rm = TRUE), digits = 3),
            van_percap_2013 = signif(mean(van_percap_2013, na.rm = TRUE), digits = 3),
            van_percap_2014 = signif(mean(van_percap_2014, na.rm = TRUE), digits = 3),
            van_percap_2015 = signif(mean(van_percap_2015, na.rm = TRUE), digits = 3),
            van_percap_2016 = signif(mean(van_percap_2016, na.rm = TRUE), digits = 3),
            van_percap_2017 = signif(mean(van_percap_2017, na.rm = TRUE), digits = 3),
            van_percap_2018 = signif(mean(van_percap_2018, na.rm = TRUE), digits = 3),
            cars_percap_2010 = signif(mean(cars_percap_2010, na.rm = TRUE), digits = 3),
            cars_percap_2011 = signif(mean(cars_percap_2011, na.rm = TRUE), digits = 3),
            cars_percap_2012 = signif(mean(cars_percap_2012, na.rm = TRUE), digits = 3),
            cars_percap_2013 = signif(mean(cars_percap_2013, na.rm = TRUE), digits = 3),
            cars_percap_2014 = signif(mean(cars_percap_2014, na.rm = TRUE), digits = 3),
            cars_percap_2015 = signif(mean(cars_percap_2015, na.rm = TRUE), digits = 3),
            cars_percap_2016 = signif(mean(cars_percap_2016, na.rm = TRUE), digits = 3),
            cars_percap_2017 = signif(mean(cars_percap_2017, na.rm = TRUE), digits = 3),
            cars_percap_2018 = signif(mean(cars_percap_2018, na.rm = TRUE), digits = 3),
            AvgCO2_cars_2010 = signif(mean(AvgCO2_cars_2010, na.rm = TRUE), digits = 3),
            AvgCO2_cars_2011 = signif(mean(AvgCO2_cars_2011, na.rm = TRUE), digits = 3),
            AvgCO2_cars_2012 = signif(mean(AvgCO2_cars_2012, na.rm = TRUE), digits = 3),
            AvgCO2_cars_2013 = signif(mean(AvgCO2_cars_2013, na.rm = TRUE), digits = 3),
            AvgCO2_cars_2014 = signif(mean(AvgCO2_cars_2014, na.rm = TRUE), digits = 3),
            AvgCO2_cars_2015 = signif(mean(AvgCO2_cars_2015, na.rm = TRUE), digits = 3),
            AvgCO2_cars_2016 = signif(mean(AvgCO2_cars_2016, na.rm = TRUE), digits = 3),
            AvgCO2_cars_2017 = signif(mean(AvgCO2_cars_2017, na.rm = TRUE), digits = 3),
            AvgCO2_cars_2018 = signif(mean(AvgCO2_cars_2018, na.rm = TRUE), digits = 3),
            ...
            epc_score_avg = signif(mean(epc_score_avg, na.rm = TRUE), digits = 3),
            ...
            floor_area_avg = signif(mean(floor_area_avg, na.rm = TRUE), digits = 3),
            low_energy_light = signif(mean(low_energy_light, na.rm = TRUE), digits = 3),
            ...
            T2W_pct = signif(mean(T2W_pct, na.rm = TRUE), digits = 3),
            ...
            T2S_bike = signif(mean(T2S_bike, na.rm = TRUE), digits = 3),
            T2S_foot = signif(mean(T2S_foot, na.rm = TRUE), digits = 3),
            T2S_car = signif(mean(T2S_car, na.rm = TRUE), digits = 3),
            T2S_other = signif(mean(T2S_other, na.rm = TRUE), digits = 3),
            T2S_pct = signif(mean(T2S_pct, na.rm = TRUE), digits = 3),
            total_kgco2e_percap = signif(mean(total_kgco2e_percap, na.rm = TRUE), digits = 3))
...
write.csv(all_la, "data/bulk_export/la_averages.csv", row.names = FALSE)
